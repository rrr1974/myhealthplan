  ...
  getBlueButtonToken(username: string, password: string, code: string, router: Router) {
   ...
   var headers = new HttpHeaders()
    ...
    urlSearchParams.set('grant_type', 'authorization_code');
     urlSearchParams.set('redirect_uri', 'http://localhost:4200/login');
    urlSearchParams.set('client_id', 'MbIiUOb2FVwoHjhoOvZNSnajcbmScPBlTYASlA0H');
     urlSearchParams.set('client_secret', '6RPbB5ByfFbj9ifkHkT0Jt3FH7zWTq9oV1uGU9QP5MSAkVCP0Z4sZV1BC5ms1EXRZoWeODAultifKe66GkKGkCmiwss7SInLNvsx2luQVwxii9RH4YAel8I7OtsjjAcC');
