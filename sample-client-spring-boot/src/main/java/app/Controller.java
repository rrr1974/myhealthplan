...
public class Controller {
	...
	/*
	 * @RequestMapping("/") public ModelAndView index(Principal principal) {
	 * System.out.println("I am in /"); ModelAndView mav = new
	 * ModelAndView("index"); return mav; }
	 * 
	 * 
	 * @RequestMapping("/principal") public Principal principal(Authentication
	 * principal) { System.out.println("I am in /principal"); token_value =
	...
	public ModelAndView getCoverage() throws JSONException {
		...
		List<Map<String, String>> coverage = coverageMap.getCoverageMap();

		mav.addObject("status", ((Map<String, String>) coverage.get(0)).get("status"));
